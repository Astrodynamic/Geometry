...
Line::Line(float x1, float y1, float x2, float y2) : m_x1(x1), m_y1(y1), m_x2(x2), m_y2(y2) {}

void Line::draw(sf::RenderWindow& window) {
  sf::Vertex line[] = {sf::Vertex(sf::Vector2f(m_x1, m_y1)), sf::Vertex(sf::Vector2f(m_x2, m_y2))};
